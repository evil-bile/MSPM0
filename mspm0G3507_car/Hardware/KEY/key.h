...
typedef struct 
{
    ...
    uint8_t Current_State;     // 按键状态机的当前状态，用于按键状态判断
}KEY;


/*  定义按键的状态*/
#define KEY_STATE_PRESSED           0   // 按下状态
#define KEY_STATE_RELEASED          1   // 释放状态
#define KEY_STATE_IDLE              2   // 空闲状态
#define KEY_STATE_SHORT_PRESSED     3   // 短按状态
#define KEY_STATE_LONG_PRESSED      4   // 长按状态
#define KEY_STATE_DOUBLE_PRESSED    5   // 双击状态
